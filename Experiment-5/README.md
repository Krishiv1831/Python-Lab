...
•	Stores only unique elements <br/>
	•	Faster membership testing <br/>
	•	Supports mathematical operations <br/>
	•	Unordered collection <br/>
	•	Efficient data handling <br/>

### Advantages of Dictionaries

•	Fast data access using keys <br/>
	•	Stores data in key-value pairs <br/>
	•	Highly flexible and efficient <br/>
	•	Easy data organization <br/>
	• Widely used in real-world applications <br/>
...
•	Unordered data <br/>
	•	Cannot access elements using index <br/>
	•	Mutable but elements must be immutable <br/> 
	•	Not suitable for duplicate data <br/>

### Disadvantages of Dictionaries

•	Keys must be unique <br/>
	•	Slightly complex syntax for beginners <br/>
	•	Cannot use mutable objects as keys <br/>
